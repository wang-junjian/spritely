window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/junjian/tmp/deepseek-harness/packages/client/ui-sprite/src/client/SpriteMascot.module.css.mjs
		const css = ".E5iRJG_anchor{pointer-events:auto;position:fixed;bottom:24px;right:24px}.E5iRJG_sprite{appearance:none;cursor:grab;-webkit-tap-highlight-color:transparent;transform-origin:50% 80%;touch-action:none;user-select:none;background:0 0;border:none;outline:none;width:96px;height:96px;padding:0}.E5iRJG_sprite:active{cursor:grabbing}.E5iRJG_sprite:focus-visible{outline:2px solid var(--dsw-static-blue-500,#3b82f6);outline-offset:4px;border-radius:50%}.E5iRJG_sprite svg{width:100%;height:100%;display:block;overflow:visible}.E5iRJG_sprite[data-pose=idle]{animation:3s ease-in-out infinite E5iRJG_float}.E5iRJG_sprite[data-pose=thinking]{animation:1.2s ease-in-out infinite E5iRJG_pulse}.E5iRJG_sprite[data-pose=writing]{animation:.7s ease-in-out infinite E5iRJG_wiggle}.E5iRJG_sprite[data-pose=working]{animation:.7s ease-in-out infinite E5iRJG_bounce}.E5iRJG_sprite[data-pose=waiting]{animation:1.6s ease-in-out infinite E5iRJG_sway}.E5iRJG_sprite[data-pose=error]{animation:.4s ease-in-out infinite E5iRJG_shake}.E5iRJG_sprite[data-pose=done]{animation:1.4s ease-in-out E5iRJG_celebrate}@keyframes E5iRJG_float{0%,to{transform:translateY(0)}50%{transform:translateY(-5px)}}@keyframes E5iRJG_pulse{0%,to{transform:scale(1)}50%{transform:scale(1.06)}}@keyframes E5iRJG_wiggle{0%,to{transform:rotate(0)}25%{transform:rotate(-4deg)}75%{transform:rotate(4deg)}}@keyframes E5iRJG_bounce{0%,to{transform:translateY(0)scale(1)}30%{transform:translateY(-10px)scale(.98,1.02)}50%{transform:translateY(0)scale(1.03,.97)}70%{transform:translateY(-4px)scale(1)}}@keyframes E5iRJG_sway{0%,to{transform:rotate(-6deg)}50%{transform:rotate(6deg)}}@keyframes E5iRJG_shake{0%,to{transform:translate(0)}25%{transform:translate(-3px)}75%{transform:translate(3px)}}@keyframes E5iRJG_celebrate{0%{transform:translateY(0)rotate(0)scale(1)}30%{transform:translateY(-16px)rotate(-8deg)scale(1.05)}60%{transform:translateY(-6px)rotate(6deg)scale(1.08)}to{transform:translateY(0)rotate(0)scale(1)}}.E5iRJG_star{transform-origin:50%;transform-box:fill-box}.E5iRJG_sprite[data-pose=done] .E5iRJG_star{animation:.9s linear infinite E5iRJG_spin}@keyframes E5iRJG_spin{0%{transform:rotate(0)}to{transform:rotate(360deg)}}.E5iRJG_gear{transform-origin:90px 44px}.E5iRJG_sprite[data-pose=working] .E5iRJG_gear{animation:1.2s linear infinite E5iRJG_spin}.E5iRJG_dots>circle{opacity:0}.E5iRJG_sprite[data-pose=thinking] .E5iRJG_dots>circle,.E5iRJG_sprite[data-pose=waiting] .E5iRJG_dots>circle{animation:1s ease-in-out infinite E5iRJG_blink}.E5iRJG_sprite[data-pose=thinking] .E5iRJG_dots>circle:nth-child(2),.E5iRJG_sprite[data-pose=waiting] .E5iRJG_dots>circle:nth-child(2){animation-delay:.2s}.E5iRJG_sprite[data-pose=thinking] .E5iRJG_dots>circle:nth-child(3),.E5iRJG_sprite[data-pose=waiting] .E5iRJG_dots>circle:nth-child(3){animation-delay:.4s}@keyframes E5iRJG_blink{0%,to{opacity:0}50%{opacity:1}}.E5iRJG_pencil{transform-origin:92px 60px;transform-box:fill-box}.E5iRJG_sprite[data-pose=writing] .E5iRJG_pencil{animation:.9s ease-in-out infinite E5iRJG_scribble}@keyframes E5iRJG_scribble{0%,to{transform:rotate(45deg)translate(0)}50%{transform:rotate(45deg)translate(2px,-2px)}}.E5iRJG_sweat{transform-origin:88px 59px;transform-box:fill-box}.E5iRJG_sprite[data-pose=error] .E5iRJG_sweat{animation:1.4s ease-in-out infinite E5iRJG_drip}@keyframes E5iRJG_drip{0%,to{opacity:.9;transform:translateY(0)}50%{opacity:.5;transform:translateY(4px)}}.E5iRJG_menu,.E5iRJG_backgroundPanel,.E5iRJG_spritePanel{color:#e0f2fe;background:#081020f5;border:1px solid #22d3ee80;border-radius:12px;animation:.15s ease-out E5iRJG_fade-in;position:absolute;top:calc(100% + 8px);right:0;box-shadow:0 0 18px #22d3ee38,0 8px 24px #00000073}.E5iRJG_anchor[data-vertical=top] .E5iRJG_menu,.E5iRJG_anchor[data-vertical=top] .E5iRJG_backgroundPanel,.E5iRJG_anchor[data-vertical=top] .E5iRJG_spritePanel{top:auto;bottom:calc(100% + 8px)}.E5iRJG_anchor[data-horizontal=start] .E5iRJG_menu,.E5iRJG_anchor[data-horizontal=start] .E5iRJG_backgroundPanel,.E5iRJG_anchor[data-horizontal=start] .E5iRJG_spritePanel{left:0;right:auto}.E5iRJG_menu{flex-direction:column;gap:4px;min-width:152px;padding:8px;display:flex}.E5iRJG_backgroundPanel{flex-direction:column;gap:8px;width:238px;padding:12px;display:flex}.E5iRJG_spritePanel{flex-direction:column;gap:8px;width:256px;padding:12px;display:flex}.E5iRJG_backgroundPanel:before,.E5iRJG_backgroundPanel:after{content:\"\";pointer-events:none;border:0 solid #22d3ee;width:12px;height:12px;position:absolute}.E5iRJG_backgroundPanel:before{border-top-width:2px;border-left-width:2px;border-top-left-radius:12px;top:-1px;left:-1px}.E5iRJG_backgroundPanel:after{border-bottom-width:2px;border-right-width:2px;border-bottom-right-radius:12px;bottom:-1px;right:-1px}.E5iRJG_menuItem{appearance:none;text-align:left;color:#e0f2fe;letter-spacing:.5px;cursor:pointer;background:0 0;border:none;border-radius:8px;align-items:center;gap:9px;padding:7px 10px;font-size:13px;display:flex}.E5iRJG_menuItem:hover{color:#a5f3fc;background:#22d3ee1f;box-shadow:inset 0 0 0 1px #22d3ee59}.E5iRJG_menuItem:focus-visible{outline-offset:2px;outline:2px solid #22d3ee}.E5iRJG_menuIcon{color:#22d3ee;flex:none;width:15px;height:15px}.E5iRJG_panelHeader{border-bottom:1px solid #22d3ee40;justify-content:space-between;align-items:center;padding-bottom:8px;display:flex}.E5iRJG_panelTitle{letter-spacing:1px;color:#a5f3fc;align-items:center;gap:7px;font-size:13px;font-weight:500;display:flex}.E5iRJG_panelTitle:before{content:\"\";background:#22d3ee;border-radius:50%;width:7px;height:7px;animation:1.4s ease-in-out infinite E5iRJG_beacon;box-shadow:0 0 8px #22d3ee}.E5iRJG_panelBack{appearance:none;color:#7dd3fc;letter-spacing:.5px;cursor:pointer;background:0 0;border:none;border-radius:6px;padding:2px 6px;font-size:12px}.E5iRJG_panelBack:hover{color:#a5f3fc;background:#22d3ee1f}.E5iRJG_sectionLabel{letter-spacing:1px;color:#7dd3fc;font-size:11px}.E5iRJG_swatches{flex-wrap:wrap;gap:8px;display:flex}.E5iRJG_swatch{appearance:none;cursor:pointer;border:1px solid #22d3ee66;border-radius:50%;width:26px;height:26px;padding:0;box-shadow:inset 0 0 0 1px #ffffff2e}.E5iRJG_swatch:hover{border-color:#22d3eecc}.E5iRJG_swatch[data-selected]{outline-offset:2px;border-color:#22d3ee;outline:2px solid #22d3ee;box-shadow:0 0 10px #22d3eeb3}.E5iRJG_imageRow{gap:6px;display:flex}.E5iRJG_imageInput{color:#e0f2fe;background:#0f1e37e6;border:1px solid #22d3ee66;border-radius:6px;flex:1;min-width:0;padding:5px 8px;font-size:12px}.E5iRJG_imageInput::placeholder{color:#7dd3fc;opacity:.7}.E5iRJG_imageInput:focus-visible{outline-offset:1px;outline:2px solid #22d3ee}.E5iRJG_imageApply{appearance:none;color:#062033;letter-spacing:1px;cursor:pointer;background:#22d3ee;border:none;border-radius:6px;padding:5px 12px;font-size:12px;box-shadow:0 0 10px #22d3ee73}.E5iRJG_imageApply:hover{background:#67e8f9}.E5iRJG_uploadButton{appearance:none;text-align:center;color:#7dd3fc;letter-spacing:1px;cursor:pointer;background:0 0;border:1px dashed #22d3ee80;border-radius:6px;padding:6px 8px;font-size:12px;display:block}.E5iRJG_uploadButton:hover{color:#a5f3fc;background:#22d3ee14;border-color:#22d3ee}.E5iRJG_fitRow{gap:6px;display:flex}.E5iRJG_fitButton{appearance:none;color:#7dd3fc;letter-spacing:.5px;cursor:pointer;background:0 0;border:1px solid #22d3ee4d;border-radius:6px;flex:1;padding:5px 8px;font-size:12px}.E5iRJG_fitButton:hover{color:#a5f3fc;border-color:#22d3eeb3}.E5iRJG_fitButton[data-selected]{color:#a5f3fc;background:#22d3ee1f;border-color:#22d3ee;box-shadow:0 0 10px #22d3ee4d}.E5iRJG_veilSlider{accent-color:#22d3ee;width:100%}.E5iRJG_reset{appearance:none;text-align:center;color:#7dd3fc;letter-spacing:1px;cursor:pointer;background:0 0;border:1px solid #22d3ee4d;border-radius:6px;padding:6px 8px;font-size:13px}.E5iRJG_reset:hover{color:#a5f3fc;background:#22d3ee14;border-color:#22d3eeb3}.E5iRJG_spriteGrid{grid-template-columns:1fr 1fr;gap:8px;display:grid}.E5iRJG_spriteOption{appearance:none;color:#7dd3fc;cursor:pointer;background:0 0;border:1px solid #22d3ee4d;border-radius:10px;flex-direction:column;align-items:center;gap:4px;padding:8px 4px 7px;display:flex}.E5iRJG_spriteOption:hover{border-color:#22d3eeb3}.E5iRJG_spriteOption[data-selected]{color:#a5f3fc;border-color:#22d3ee;box-shadow:0 0 12px #22d3ee59}.E5iRJG_spriteOption svg{width:56px;height:56px}.E5iRJG_spriteName{letter-spacing:.5px;font-size:12px}@keyframes E5iRJG_fade-in{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:translateY(0)}}@keyframes E5iRJG_beacon{0%,to{opacity:1}50%{opacity:.35}}.E5iRJG_attentionDot{border:2px solid var(--dsw-alias-bg-layer-1);border-radius:50%;width:10px;height:10px;position:absolute;top:2px;right:2px}.E5iRJG_attentionDot[data-kind=waiting]{background:var(--dsw-alias-state-warn-primary)}.E5iRJG_attentionDot[data-kind=error]{background:var(--dsw-alias-state-error-primary)}";
		...
		var SpriteMascot_module_css_default = {
			"sweat": "E5iRJG_sweat",
			"anchor": "E5iRJG_anchor",
			"menuItem": "E5iRJG_menuItem",
			"backgroundPanel": "E5iRJG_backgroundPanel",
			"swatches": "E5iRJG_swatches",
			"uploadButton": "E5iRJG_uploadButton",
			"pencil": "E5iRJG_pencil",
			"imageApply": "E5iRJG_imageApply",
			"panelTitle": "E5iRJG_panelTitle",
			"fitRow": "E5iRJG_fitRow",
			"shake": "E5iRJG_shake",
			"drip": "E5iRJG_drip",
			"spriteName": "E5iRJG_spriteName",
			"spritePanel": "E5iRJG_spritePanel",
			"float": "E5iRJG_float",
			"imageRow": "E5iRJG_imageRow",
			"menuIcon": "E5iRJG_menuIcon",
			"celebrate": "E5iRJG_celebrate",
			"blink": "E5iRJG_blink",
			"sectionLabel": "E5iRJG_sectionLabel",
			"bounce": "E5iRJG_bounce",
			"sprite": "E5iRJG_sprite",
			"imageInput": "E5iRJG_imageInput",
			"dots": "E5iRJG_dots",
			"panelHeader": "E5iRJG_panelHeader",
			"wiggle": "E5iRJG_wiggle",
			"spriteGrid": "E5iRJG_spriteGrid",
			"star": "E5iRJG_star",
			"spriteOption": "E5iRJG_spriteOption",
			"attentionDot": "E5iRJG_attentionDot",
			"beacon": "E5iRJG_beacon",
			"scribble": "E5iRJG_scribble",
			"panelBack": "E5iRJG_panelBack",
			"sway": "E5iRJG_sway",
			"pulse": "E5iRJG_pulse",
			"fade-in": "E5iRJG_fade-in",
			"gear": "E5iRJG_gear",
			"menu": "E5iRJG_menu",
			"swatch": "E5iRJG_swatch",
			"fitButton": "E5iRJG_fitButton",
			"veilSlider": "E5iRJG_veilSlider",
			"spin": "E5iRJG_spin",
			"reset": "E5iRJG_reset"
		};
		//#endregion
		...
		*/
		function SpriteMascot({ useSprite, useBackground, useSpriteKind, startSession, setBackground, setSpriteKind, t }) {
			...
			(0, react.useLayoutEffect)(() => {
				...
				setMenuPlacement({
					vertical: window.innerHeight - anchorRect.bottom < neededHeight && anchorRect.top >= neededHeight ? "top" : "bottom",
					horizontal: anchorRect.right - popoverRect.width < 0 && anchorRect.left + popoverRect.width <= window.innerWidth ? "start" : "end"
				});
			}, [panel]);
