window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region lib/types/client/sprite-position-source.js
		/**
		...
		* @returns the source.
		*/
		function createSpritePositionSource() {
			const store = (0, _deepseek_ai_dsh_client_runtime_client.createSnapshotStore)(null, { persist: { name: POSITION_PERSIST_KEY } });
			const raw = store.getSnapshot();
		...
		*/
		...
		const css = ".G-sUUq_anchor{pointer-events:auto;position:fixed;bottom:24px;right:24px}.G-sUUq_sprite{appearance:none;cursor:grab;-webkit-tap-highlight-color:transparent;transform-origin:50% 80%;touch-action:none;user-select:none;background:0 0;border:none;outline:none;width:96px;height:96px;padding:0}.G-sUUq_sprite:active{cursor:grabbing}.G-sUUq_sprite:focus-visible{outline:2px solid var(--dsw-static-blue-500,#3b82f6);outline-offset:4px;border-radius:50%}.G-sUUq_spriteBody{transform-origin:50% 80%;width:100%;height:100%;transition:transform .1s ease-out;display:block}.G-sUUq_sprite svg{width:100%;height:100%;display:block;overflow:visible}.G-sUUq_sprite:active .G-sUUq_spriteBody{animation-play-state:paused!important;transform:scale(.94)!important}.G-sUUq_sprite[data-pose=idle] .G-sUUq_spriteBody{animation:3s ease-in-out infinite G-sUUq_float}.G-sUUq_sprite[data-pose=thinking] .G-sUUq_spriteBody{animation:1.2s ease-in-out infinite G-sUUq_pulse}.G-sUUq_sprite[data-pose=writing] .G-sUUq_spriteBody{animation:.7s ease-in-out infinite G-sUUq_wiggle}.G-sUUq_sprite[data-pose=working] .G-sUUq_spriteBody{animation:.7s ease-in-out infinite G-sUUq_bounce}.G-sUUq_sprite[data-pose=waiting] .G-sUUq_spriteBody{animation:1.6s ease-in-out infinite G-sUUq_sway}.G-sUUq_sprite[data-pose=error] .G-sUUq_spriteBody{animation:.4s ease-in-out infinite G-sUUq_shake}.G-sUUq_sprite[data-pose=done] .G-sUUq_spriteBody{animation:1.4s ease-in-out G-sUUq_celebrate}@keyframes G-sUUq_float{0%,to{transform:translateY(0)}50%{transform:translateY(-5px)}}@keyframes G-sUUq_pulse{0%,to{transform:scale(1)}50%{transform:scale(1.06)}}@keyframes G-sUUq_wiggle{0%,to{transform:rotate(0)}25%{transform:rotate(-4deg)}75%{transform:rotate(4deg)}}@keyframes G-sUUq_bounce{0%,to{transform:translateY(0)scale(1)}30%{transform:translateY(-10px)scale(.98,1.02)}50%{transform:translateY(0)scale(1.03,.97)}70%{transform:translateY(-4px)scale(1)}}@keyframes G-sUUq_sway{0%,to{transform:rotate(-6deg)}50%{transform:rotate(6deg)}}@keyframes G-sUUq_shake{0%,to{transform:translate(0)}25%{transform:translate(-3px)}75%{transform:translate(3px)}}@keyframes G-sUUq_celebrate{0%{transform:translateY(0)rotate(0)scale(1)}30%{transform:translateY(-16px)rotate(-8deg)scale(1.05)}60%{transform:translateY(-6px)rotate(6deg)scale(1.08)}to{transform:translateY(0)rotate(0)scale(1)}}.G-sUUq_star{transform-origin:50%;transform-box:fill-box}.G-sUUq_sprite[data-pose=done] .G-sUUq_star{animation:.9s linear infinite G-sUUq_spin}@keyframes G-sUUq_spin{0%{transform:rotate(0)}to{transform:rotate(360deg)}}.G-sUUq_gear{transform-origin:90px 44px}.G-sUUq_sprite[data-pose=working] .G-sUUq_gear{animation:1.2s linear infinite G-sUUq_spin}.G-sUUq_dots>circle{opacity:0}.G-sUUq_sprite[data-pose=thinking] .G-sUUq_dots>circle,.G-sUUq_sprite[data-pose=waiting] .G-sUUq_dots>circle{animation:1s ease-in-out infinite G-sUUq_blink}.G-sUUq_sprite[data-pose=thinking] .G-sUUq_dots>circle:nth-child(2),.G-sUUq_sprite[data-pose=waiting] .G-sUUq_dots>circle:nth-child(2){animation-delay:.2s}.G-sUUq_sprite[data-pose=thinking] .G-sUUq_dots>circle:nth-child(3),.G-sUUq_sprite[data-pose=waiting] .G-sUUq_dots>circle:nth-child(3){animation-delay:.4s}@keyframes G-sUUq_blink{0%,to{opacity:0}50%{opacity:1}}.G-sUUq_sweat{transform-origin:88px 59px;transform-box:fill-box}.G-sUUq_sprite[data-pose=error] .G-sUUq_sweat{animation:1.4s ease-in-out infinite G-sUUq_drip}@keyframes G-sUUq_drip{0%,to{opacity:.9;transform:translateY(0)}50%{opacity:.5;transform:translateY(4px)}}.G-sUUq_blob{transform-origin:60px 80px;animation:2.6s ease-in-out infinite G-sUUq_blob-breathe}.G-sUUq_blobBody{transform-origin:60px 70px}.G-sUUq_blobAntenna{transform-origin:60px 32px;animation:3s ease-in-out infinite G-sUUq_blob-antenna-wiggle}.G-sUUq_blobAntenna .G-sUUq_star{transform-origin:56px 13px;transform-box:fill-box}.G-sUUq_blobEyes{transform-origin:60px 66px}.G-sUUq_blobEyelid{opacity:0;animation:4s ease-in-out infinite G-sUUq_blob-blink}.G-sUUq_blobCheeks{transform-origin:60px 78px;animation:3s ease-in-out infinite G-sUUq_blob-cheek-pulse}.G-sUUq_blobFace{transform-origin:60px 82px}.G-sUUq_sprite[data-pose=thinking] .G-sUUq_blobAntenna{animation:1.2s ease-in-out infinite G-sUUq_blob-antenna-wiggle}.G-sUUq_sprite[data-pose=writing] .G-sUUq_blobBody{animation:.7s ease-in-out infinite G-sUUq_blob-tilt}.G-sUUq_sprite[data-pose=working] .G-sUUq_blobAntenna .G-sUUq_star{animation:.6s linear infinite G-sUUq_spin}.G-sUUq_sprite[data-pose=waiting] .G-sUUq_blob{animation:1.6s ease-in-out infinite G-sUUq_blob-sway}.G-sUUq_sprite[data-pose=error] .G-sUUq_blob{animation:.35s ease-in-out infinite G-sUUq_blob-shiver}.G-sUUq_sprite[data-pose=error] .G-sUUq_blobAntenna{transform:rotate(-18deg)}.G-sUUq_sprite[data-pose=done] .G-sUUq_blobAntenna .G-sUUq_star{animation:.5s linear infinite G-sUUq_spin}@keyframes G-sUUq_blob-breathe{0%,to{transform:scale(1)translateY(0)}50%{transform:scale(1.02,.98)translateY(-1.5px)}}@keyframes G-sUUq_blob-antenna-wiggle{0%,to{transform:rotate(-8deg)}50%{transform:rotate(8deg)}}@keyframes G-sUUq_blob-tilt{0%,to{transform:rotate(0)}25%{transform:rotate(-3deg)}75%{transform:rotate(3deg)}}@keyframes G-sUUq_blob-sway{0%,to{transform:rotate(-4deg)}50%{transform:rotate(4deg)}}@keyframes G-sUUq_blob-shiver{0%,to{transform:translate(0)}25%{transform:translate(-2px)}75%{transform:translate(2px)}}@keyframes G-sUUq_blob-blink{0%,96%,to{opacity:0}98%{opacity:1}}@keyframes G-sUUq_blob-cheek-pulse{0%,to{opacity:.85}50%{opacity:1}}.G-sUUq_bot{transform-origin:60px 70px;animation:3s ease-in-out infinite G-sUUq_bot-hover}.G-sUUq_botAntenna{transform-origin:60px 28px;animation:2s ease-in-out infinite G-sUUq_bot-beacon}.G-sUUq_botHead{transform-origin:60px 70px;animation:2.5s ease-in-out infinite G-sUUq_bot-face-breathe}.G-sUUq_botEyes{transform-origin:60px 66px}.G-sUUq_botScan{transform-origin:50%;transform-box:fill-box;opacity:0}.G-sUUq_sprite[data-pose=thinking] .G-sUUq_botScan,.G-sUUq_sprite[data-pose=working] .G-sUUq_botScan{opacity:.4;animation:2s linear infinite G-sUUq_bot-scan}.G-sUUq_sprite[data-pose=thinking] .G-sUUq_botScan{animation-duration:1s}.G-sUUq_sprite[data-pose=working] .G-sUUq_botScan{animation-duration:.5s}.G-sUUq_botEyeRight .G-sUUq_botScan{animation-delay:.3s}.G-sUUq_sprite[data-pose=thinking] .G-sUUq_botAntenna{animation:.8s ease-in-out infinite G-sUUq_bot-beacon}.G-sUUq_sprite[data-pose=working] .G-sUUq_botAntenna{animation:.4s ease-in-out infinite G-sUUq_bot-beacon}.G-sUUq_sprite[data-pose=error] .G-sUUq_botAntenna circle{fill:#ef4444}.G-sUUq_sprite[data-pose=error] .G-sUUq_bot{animation:.35s ease-in-out infinite G-sUUq_bot-malfunction}.G-sUUq_sprite[data-pose=done] .G-sUUq_botAntenna circle{fill:#22c55e}@keyframes G-sUUq_bot-hover{0%,to{transform:translateY(0)}50%{transform:translateY(-4px)}}@keyframes G-sUUq_bot-beacon{0%,to{opacity:1;filter:drop-shadow(0 0 2px #6ee7b7)}50%{opacity:.6;filter:drop-shadow(0 0 6px #6ee7b7)}}@keyframes G-sUUq_bot-face-breathe{0%,to{transform:scale(1)}50%{transform:scale(1.01)}}@keyframes G-sUUq_bot-scan{0%{opacity:0;transform:translate(-22px)}20%{opacity:.4}80%{opacity:.4}to{opacity:0;transform:translate(22px)}}@keyframes G-sUUq_bot-malfunction{0%,to{transform:translate(0)}25%{transform:translate(-2px)rotate(-1deg)}75%{transform:translate(2px)rotate(1deg)}}.G-sUUq_ghost{transform-origin:60px 70px;animation:3.2s ease-in-out infinite G-sUUq_ghost-float}.G-sUUq_ghostBody{transform-origin:60px 70px;animation:3s ease-in-out infinite G-sUUq_ghost-fade}.G-sUUq_ghostHem{transform-origin:60px 82px;animation:2s ease-in-out infinite G-sUUq_ghost-hem-wave}.G-sUUq_ghostEyes{transform-origin:60px 66px}.G-sUUq_ghostEyelid{opacity:0;animation:4s ease-in-out infinite G-sUUq_ghost-blink}.G-sUUq_ghostCheeks{transform-origin:60px 78px;animation:3s ease-in-out infinite G-sUUq_ghost-cheek-pulse}.G-sUUq_sprite[data-pose=thinking] .G-sUUq_ghost{animation:2s ease-in-out infinite G-sUUq_ghost-sway}.G-sUUq_sprite[data-pose=thinking] .G-sUUq_ghostHem{animation:1s ease-in-out infinite G-sUUq_ghost-hem-wave}.G-sUUq_sprite[data-pose=working] .G-sUUq_ghostBody{animation:.8s ease-in-out infinite G-sUUq_ghost-fade}.G-sUUq_sprite[data-pose=waiting] .G-sUUq_ghost{animation:1.6s ease-in-out infinite G-sUUq_ghost-sway}.G-sUUq_sprite[data-pose=error] .G-sUUq_ghost{animation:.35s ease-in-out infinite G-sUUq_ghost-shiver}.G-sUUq_sprite[data-pose=error] .G-sUUq_ghostBody path,.G-sUUq_sprite[data-pose=error] .G-sUUq_ghostHem path{fill:var(--dsw-static-purple-300,#c4b5fd);stroke:var(--dsw-alias-state-error-primary,#ef4444)}.G-sUUq_sprite[data-pose=done] .G-sUUq_ghost{animation:1.2s ease-in-out infinite G-sUUq_ghost-bounce}@keyframes G-sUUq_ghost-float{0%,to{transform:translateY(0)}50%{transform:translateY(-5px)}}@keyframes G-sUUq_ghost-fade{0%,to{opacity:.95}50%{opacity:1}}@keyframes G-sUUq_ghost-hem-wave{0%,to{transform:skew(-2deg)}50%{transform:skew(2deg)}}@keyframes G-sUUq_ghost-sway{0%,to{transform:rotate(-3deg)}50%{transform:rotate(3deg)}}@keyframes G-sUUq_ghost-shiver{0%,to{transform:translate(0)}25%{transform:translate(-2px)}75%{transform:translate(2px)}}@keyframes G-sUUq_ghost-bounce{0%,to{transform:translateY(0)}30%{transform:translateY(-8px)}50%{transform:translateY(0)}70%{transform:translateY(-4px)}}@keyframes G-sUUq_ghost-blink{0%,96%,to{opacity:0}98%{opacity:1}}@keyframes G-sUUq_ghost-cheek-pulse{0%,to{opacity:.85}50%{opacity:1}}.G-sUUq_cat{transform-origin:60px 95px;animation:2.4s ease-in-out infinite G-sUUq_cat-breathe}.G-sUUq_catTail{transform-origin:76px 90px;animation:3s ease-in-out infinite G-sUUq_cat-tail-idle}.G-sUUq_catEarLeft,.G-sUUq_catEarRight{transform-origin:40px 38px;transition:transform .25s cubic-bezier(.34,1.56,.64,1)}.G-sUUq_catEarRight{transform-origin:80px 38px}.G-sUUq_catEyelid{opacity:0;animation:4s ease-in-out infinite G-sUUq_cat-blink}.G-sUUq_catWhiskers{transform-origin:60px 72px;animation:5s ease-in-out infinite G-sUUq_cat-whisker-twitch}.G-sUUq_catPaws{transform-origin:60px 108px;animation:4s ease-in-out infinite G-sUUq_cat-paw-tap}.G-sUUq_sprite[data-pose=thinking] .G-sUUq_catEarLeft{transform:rotate(8deg)}.G-sUUq_sprite[data-pose=thinking] .G-sUUq_catEarRight{transform:rotate(-8deg)}.G-sUUq_sprite[data-pose=writing] .G-sUUq_catEarLeft{transform:rotate(10deg)}.G-sUUq_sprite[data-pose=writing] .G-sUUq_catEarRight{transform:rotate(-4deg)}.G-sUUq_sprite[data-pose=working] .G-sUUq_catEarLeft{transform:rotate(14deg)}.G-sUUq_sprite[data-pose=working] .G-sUUq_catEarRight{transform:rotate(-14deg)}.G-sUUq_sprite[data-pose=waiting] .G-sUUq_catEarLeft{transform:rotate(6deg)}.G-sUUq_sprite[data-pose=waiting] .G-sUUq_catEarRight{transform:rotate(-6deg)}.G-sUUq_sprite[data-pose=error] .G-sUUq_catEarLeft{transform:rotate(-24deg)}.G-sUUq_sprite[data-pose=error] .G-sUUq_catEarRight{transform:rotate(24deg)}.G-sUUq_sprite[data-pose=done] .G-sUUq_catEarLeft{transform:rotate(-8deg)}.G-sUUq_sprite[data-pose=done] .G-sUUq_catEarRight{transform:rotate(8deg)}.G-sUUq_sprite[data-pose=thinking] .G-sUUq_catTail{animation:2s ease-in-out infinite G-sUUq_cat-tail-tip}.G-sUUq_sprite[data-pose=writing] .G-sUUq_catTail{animation:2.5s ease-in-out infinite G-sUUq_cat-tail-slow}.G-sUUq_sprite[data-pose=working] .G-sUUq_catTail{animation:.7s ease-in-out infinite G-sUUq_cat-tail-alert}.G-sUUq_sprite[data-pose=waiting] .G-sUUq_catTail{animation:2s ease-in-out infinite G-sUUq_cat-tail-wrap}.G-sUUq_sprite[data-pose=error] .G-sUUq_catTail{animation:.35s ease-in-out infinite G-sUUq_cat-tail-puff}.G-sUUq_sprite[data-pose=done] .G-sUUq_catTail{animation:1.2s ease-in-out infinite G-sUUq_cat-tail-happy}.G-sUUq_catThought circle{opacity:0;transform-origin:50%;transform-box:fill-box;animation:2.2s ease-in-out infinite G-sUUq_cat-thought-pop}.G-sUUq_catThought circle:nth-child(2){animation-delay:.2s}.G-sUUq_catThought circle:nth-child(3){animation-delay:.4s}.G-sUUq_catPencil,.G-sUUq_headPencil{transform-origin:70px 18px;animation:.45s ease-in-out infinite G-sUUq_cat-pencil-scribble}.G-sUUq_catHeadGear g:last-child{transform-origin:60px 6px;animation:1.2s linear infinite G-sUUq_spin}.G-sUUq_catSpeech circle{opacity:0;animation:1.2s ease-in-out infinite G-sUUq_blink}.G-sUUq_catSpeech circle:nth-child(2){animation-delay:.2s}.G-sUUq_catSpeech circle:nth-child(3){animation-delay:.4s}.G-sUUq_catSweat{transform-origin:48px 50px;animation:1.4s ease-in-out infinite G-sUUq_cat-sweat-drip}.G-sUUq_catStars .G-sUUq_star{transform-origin:50%;transform-box:fill-box;animation:1.4s ease-out infinite G-sUUq_cat-star-burst}.G-sUUq_catStars .G-sUUq_star:nth-child(2){animation-delay:.2s}.G-sUUq_catStars .G-sUUq_star:nth-child(3){animation-delay:.4s}@keyframes G-sUUq_cat-breathe{0%,to{transform:scale(1)translateY(0)}50%{transform:scale(1.015,.985)translateY(-1.5px)}}@keyframes G-sUUq_cat-tail-idle{0%,to{transform:rotate(-6deg)}50%{transform:rotate(10deg)}}@keyframes G-sUUq_cat-tail-tip{0%,to{transform:rotate(-2deg)}50%{transform:rotate(6deg)}}@keyframes G-sUUq_cat-tail-slow{0%,to{transform:rotate(-4deg)}50%{transform:rotate(8deg)}}@keyframes G-sUUq_cat-tail-alert{0%,to{transform:rotate(-4deg)}50%{transform:rotate(4deg)}}@keyframes G-sUUq_cat-tail-wrap{0%,to{transform:rotate(-8deg)}50%{transform:rotate(2deg)}}@keyframes G-sUUq_cat-tail-puff{0%,to{transform:rotate(-10deg)scale(1)}50%{transform:rotate(10deg)scale(1.08)}}@keyframes G-sUUq_cat-tail-happy{0%,to{transform:rotate(-12deg)}25%{transform:rotate(8deg)}75%{transform:rotate(-4deg)}}@keyframes G-sUUq_cat-blink{0%,96%,to{opacity:0}98%{opacity:1}}@keyframes G-sUUq_cat-whisker-twitch{0%,90%,to{transform:rotate(0)}92%{transform:rotate(.8deg)}94%{transform:rotate(-.4deg)}96%{transform:rotate(.6deg)}}@keyframes G-sUUq_cat-paw-tap{0%,90%,to{transform:translateY(0)}95%{transform:translateY(-2px)}}@keyframes G-sUUq_cat-thought-pop{0%,to{opacity:0;transform:scale(.5)}30%,70%{opacity:1;transform:scale(1)}}@keyframes G-sUUq_cat-pencil-scribble{0%{transform:translate(-2px)}20%{transform:translate(2px,-1px)}40%{transform:translate(-1px,1px)}60%{transform:translate(2px)}80%{transform:translate(-1px,-1px)}to{transform:translate(-2px)}}@keyframes G-sUUq_cat-sweat-drip{0%,to{opacity:.9;transform:translateY(0)}50%{opacity:.5;transform:translateY(5px)}}@keyframes G-sUUq_cat-star-burst{0%{opacity:1;transform:scale(0)translateY(0)}60%{opacity:1}to{opacity:0;transform:scale(1.3)translateY(-14px)}}.G-sUUq_menu,.G-sUUq_backgroundPanel,.G-sUUq_spritePanel{color:#e0f2fe;background:#081020f5;border:1px solid #22d3ee80;border-radius:12px;animation:.15s ease-out G-sUUq_fade-in;position:absolute;top:calc(100% + 8px);right:0;box-shadow:0 0 18px #22d3ee38,0 8px 24px #00000073}.G-sUUq_anchor[data-vertical=top] .G-sUUq_menu,.G-sUUq_anchor[data-vertical=top] .G-sUUq_backgroundPanel,.G-sUUq_anchor[data-vertical=top] .G-sUUq_spritePanel{top:auto;bottom:calc(100% + 8px)}.G-sUUq_anchor[data-horizontal=start] .G-sUUq_menu,.G-sUUq_anchor[data-horizontal=start] .G-sUUq_backgroundPanel,.G-sUUq_anchor[data-horizontal=start] .G-sUUq_spritePanel{left:0;right:auto}.G-sUUq_menu{flex-direction:column;gap:4px;min-width:152px;padding:8px;display:flex}.G-sUUq_menuStatus{color:#a5f3fc;letter-spacing:.5px;background:#22d3ee14;border-radius:8px;align-items:center;gap:8px;padding:6px 10px;font-size:12px;display:flex}.G-sUUq_menuStatusDot{background:#22d3ee;border-radius:50%;flex:none;width:8px;height:8px;box-shadow:0 0 8px #22d3ee}.G-sUUq_menuStatusDot[data-activity=waiting]{background:var(--dsw-alias-state-warn-primary,#f59e0b);box-shadow:0 0 8px var(--dsw-alias-state-warn-primary,#f59e0b)}.G-sUUq_menuStatusDot[data-activity=error]{background:var(--dsw-alias-state-error-primary,#ef4444);box-shadow:0 0 8px var(--dsw-alias-state-error-primary,#ef4444)}.G-sUUq_backgroundPanel{flex-direction:column;gap:8px;width:238px;padding:12px;display:flex}.G-sUUq_spritePanel{flex-direction:column;gap:8px;width:256px;padding:12px;display:flex}.G-sUUq_backgroundPanel:before,.G-sUUq_backgroundPanel:after{content:\"\";pointer-events:none;border:0 solid #22d3ee;width:12px;height:12px;position:absolute}.G-sUUq_backgroundPanel:before{border-top-width:2px;border-left-width:2px;border-top-left-radius:12px;top:-1px;left:-1px}.G-sUUq_backgroundPanel:after{border-bottom-width:2px;border-right-width:2px;border-bottom-right-radius:12px;bottom:-1px;right:-1px}.G-sUUq_menuItem{appearance:none;text-align:left;color:#e0f2fe;letter-spacing:.5px;cursor:pointer;background:0 0;border:none;border-radius:8px;align-items:center;gap:9px;padding:7px 10px;font-size:13px;display:flex}.G-sUUq_menuItem:hover{color:#a5f3fc;background:#22d3ee1f;box-shadow:inset 0 0 0 1px #22d3ee59}.G-sUUq_menuItem:focus-visible{outline-offset:2px;outline:2px solid #22d3ee}.G-sUUq_menuIcon{color:#22d3ee;flex:none;width:15px;height:15px}.G-sUUq_panelHeader{border-bottom:1px solid #22d3ee40;justify-content:space-between;align-items:center;padding-bottom:8px;display:flex}.G-sUUq_panelTitle{letter-spacing:1px;color:#a5f3fc;align-items:center;gap:7px;font-size:13px;font-weight:500;display:flex}.G-sUUq_panelTitle:before{content:\"\";background:#22d3ee;border-radius:50%;width:7px;height:7px;animation:1.4s ease-in-out infinite G-sUUq_beacon;box-shadow:0 0 8px #22d3ee}.G-sUUq_panelBack{appearance:none;color:#7dd3fc;letter-spacing:.5px;cursor:pointer;background:0 0;border:none;border-radius:6px;padding:2px 6px;font-size:12px}.G-sUUq_panelBack:hover{color:#a5f3fc;background:#22d3ee1f}.G-sUUq_sectionLabel{letter-spacing:1px;color:#7dd3fc;font-size:11px}.G-sUUq_swatches{flex-wrap:wrap;gap:8px;display:flex}.G-sUUq_swatch{appearance:none;cursor:pointer;border:1px solid #22d3ee66;border-radius:50%;width:26px;height:26px;padding:0;box-shadow:inset 0 0 0 1px #ffffff2e}.G-sUUq_swatch:hover{border-color:#22d3eecc}.G-sUUq_swatch[data-selected]{outline-offset:2px;border-color:#22d3ee;outline:2px solid #22d3ee;box-shadow:0 0 10px #22d3eeb3}.G-sUUq_imageRow{gap:6px;display:flex}.G-sUUq_imageInput{color:#e0f2fe;background:#0f1e37e6;border:1px solid #22d3ee66;border-radius:6px;flex:1;min-width:0;padding:5px 8px;font-size:12px}.G-sUUq_imageInput::placeholder{color:#7dd3fc;opacity:.7}.G-sUUq_imageInput:focus-visible{outline-offset:1px;outline:2px solid #22d3ee}.G-sUUq_imageApply{appearance:none;color:#062033;letter-spacing:1px;cursor:pointer;background:#22d3ee;border:none;border-radius:6px;padding:5px 12px;font-size:12px;box-shadow:0 0 10px #22d3ee73}.G-sUUq_imageApply:hover{background:#67e8f9}.G-sUUq_uploadButton{appearance:none;text-align:center;color:#7dd3fc;letter-spacing:1px;cursor:pointer;background:0 0;border:1px dashed #22d3ee80;border-radius:6px;padding:6px 8px;font-size:12px;display:block}.G-sUUq_uploadButton:hover{color:#a5f3fc;background:#22d3ee14;border-color:#22d3ee}.G-sUUq_fitRow{gap:6px;display:flex}.G-sUUq_fitButton{appearance:none;color:#7dd3fc;letter-spacing:.5px;cursor:pointer;background:0 0;border:1px solid #22d3ee4d;border-radius:6px;flex:1;padding:5px 8px;font-size:12px}.G-sUUq_fitButton:hover{color:#a5f3fc;border-color:#22d3eeb3}.G-sUUq_fitButton[data-selected]{color:#a5f3fc;background:#22d3ee1f;border-color:#22d3ee;box-shadow:0 0 10px #22d3ee4d}.G-sUUq_veilSlider{accent-color:#22d3ee;width:100%}.G-sUUq_reset{appearance:none;text-align:center;color:#7dd3fc;letter-spacing:1px;cursor:pointer;background:0 0;border:1px solid #22d3ee4d;border-radius:6px;padding:6px 8px;font-size:13px}.G-sUUq_reset:hover{color:#a5f3fc;background:#22d3ee14;border-color:#22d3eeb3}.G-sUUq_spriteGrid{grid-template-columns:1fr 1fr;gap:8px;display:grid}.G-sUUq_spriteOption{appearance:none;color:#7dd3fc;cursor:pointer;background:0 0;border:1px solid #22d3ee4d;border-radius:10px;flex-direction:column;align-items:center;gap:4px;padding:8px 4px 7px;display:flex}.G-sUUq_spriteOption:hover{border-color:#22d3eeb3}.G-sUUq_spriteOption[data-selected]{color:#a5f3fc;border-color:#22d3ee;box-shadow:0 0 12px #22d3ee59}.G-sUUq_spriteOption svg{width:56px;height:56px}.G-sUUq_spriteName{letter-spacing:.5px;font-size:12px}@keyframes G-sUUq_fade-in{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:translateY(0)}}@keyframes G-sUUq_beacon{0%,to{opacity:1}50%{opacity:.35}}.G-sUUq_attentionDot{border:2px solid var(--dsw-alias-bg-layer-1);border-radius:50%;width:10px;height:10px;position:absolute;top:2px;right:2px}.G-sUUq_attentionDot[data-kind=waiting]{background:var(--dsw-alias-state-warn-primary)}.G-sUUq_attentionDot[data-kind=error]{background:var(--dsw-alias-state-error-primary)}";
		...
		var SpriteMascot_module_css_default = {
			"spin": "G-sUUq_spin",
			"blob-tilt": "G-sUUq_blob-tilt",
			"ghost": "G-sUUq_ghost",
			"ghostEyes": "G-sUUq_ghostEyes",
			"headPencil": "G-sUUq_headPencil",
			"drip": "G-sUUq_drip",
			"botAntenna": "G-sUUq_botAntenna",
			"cat-pencil-scribble": "G-sUUq_cat-pencil-scribble",
			"botEyes": "G-sUUq_botEyes",
			"pulse": "G-sUUq_pulse",
			"ghost-shiver": "G-sUUq_ghost-shiver",
			"catStars": "G-sUUq_catStars",
			"cat-star-burst": "G-sUUq_cat-star-burst",
			"menu": "G-sUUq_menu",
			"bot": "G-sUUq_bot",
			"cat-tail-happy": "G-sUUq_cat-tail-happy",
			"blink": "G-sUUq_blink",
			"cat-thought-pop": "G-sUUq_cat-thought-pop",
			"shake": "G-sUUq_shake",
			"imageInput": "G-sUUq_imageInput",
			"spriteName": "G-sUUq_spriteName",
			"panelTitle": "G-sUUq_panelTitle",
			"cat-tail-slow": "G-sUUq_cat-tail-slow",
			"dots": "G-sUUq_dots",
			"catTail": "G-sUUq_catTail",
			"imageRow": "G-sUUq_imageRow",
			"reset": "G-sUUq_reset",
			"ghostEyelid": "G-sUUq_ghostEyelid",
			"ghostCheeks": "G-sUUq_ghostCheeks",
			"fitButton": "G-sUUq_fitButton",
			"blob-cheek-pulse": "G-sUUq_blob-cheek-pulse",
			"wiggle": "G-sUUq_wiggle",
			"celebrate": "G-sUUq_celebrate",
			"blobAntenna": "G-sUUq_blobAntenna",
			"blobEyelid": "G-sUUq_blobEyelid",
			"bot-beacon": "G-sUUq_bot-beacon",
			"bot-face-breathe": "G-sUUq_bot-face-breathe",
			"ghost-cheek-pulse": "G-sUUq_ghost-cheek-pulse",
			"cat-tail-puff": "G-sUUq_cat-tail-puff",
			"menuStatus": "G-sUUq_menuStatus",
			"ghost-fade": "G-sUUq_ghost-fade",
			"cat-paw-tap": "G-sUUq_cat-paw-tap",
			"catThought": "G-sUUq_catThought",
			"sectionLabel": "G-sUUq_sectionLabel",
			"blob-sway": "G-sUUq_blob-sway",
			"ghost-bounce": "G-sUUq_ghost-bounce",
			"blob-breathe": "G-sUUq_blob-breathe",
			"botHead": "G-sUUq_botHead",
			"ghost-blink": "G-sUUq_ghost-blink",
			"catWhiskers": "G-sUUq_catWhiskers",
			"backgroundPanel": "G-sUUq_backgroundPanel",
			"fade-in": "G-sUUq_fade-in",
			"bot-scan": "G-sUUq_bot-scan",
			"menuStatusDot": "G-sUUq_menuStatusDot",
			"catEarLeft": "G-sUUq_catEarLeft",
			"ghost-hem-wave": "G-sUUq_ghost-hem-wave",
			"blobCheeks": "G-sUUq_blobCheeks",
			"blob-blink": "G-sUUq_blob-blink",
			"cat-whisker-twitch": "G-sUUq_cat-whisker-twitch",
			"catEyelid": "G-sUUq_catEyelid",
			"beacon": "G-sUUq_beacon",
			"blobBody": "G-sUUq_blobBody",
			"panelBack": "G-sUUq_panelBack",
			"swatch": "G-sUUq_swatch",
			"catHeadGear": "G-sUUq_catHeadGear",
			"imageApply": "G-sUUq_imageApply",
			"fitRow": "G-sUUq_fitRow",
			"spriteOption": "G-sUUq_spriteOption",
			"star": "G-sUUq_star",
			"sweat": "G-sUUq_sweat",
			"blob-shiver": "G-sUUq_blob-shiver",
			"ghost-float": "G-sUUq_ghost-float",
			"menuIcon": "G-sUUq_menuIcon",
			"spriteBody": "G-sUUq_spriteBody",
			"bot-hover": "G-sUUq_bot-hover",
			"cat-tail-wrap": "G-sUUq_cat-tail-wrap",
			"gear": "G-sUUq_gear",
			"sway": "G-sUUq_sway",
			"botScan": "G-sUUq_botScan",
			"cat-tail-idle": "G-sUUq_cat-tail-idle",
			"catEarRight": "G-sUUq_catEarRight",
			"cat-tail-alert": "G-sUUq_cat-tail-alert",
			"catSpeech": "G-sUUq_catSpeech",
			"catSweat": "G-sUUq_catSweat",
			"swatches": "G-sUUq_swatches",
			"ghostBody": "G-sUUq_ghostBody",
			"cat-tail-tip": "G-sUUq_cat-tail-tip",
			"ghost-sway": "G-sUUq_ghost-sway",
			"blob": "G-sUUq_blob",
			"catPaws": "G-sUUq_catPaws",
			"bot-malfunction": "G-sUUq_bot-malfunction",
			"cat": "G-sUUq_cat",
			"float": "G-sUUq_float",
			"uploadButton": "G-sUUq_uploadButton",
			"panelHeader": "G-sUUq_panelHeader",
			"veilSlider": "G-sUUq_veilSlider",
			"cat-sweat-drip": "G-sUUq_cat-sweat-drip",
			"spritePanel": "G-sUUq_spritePanel",
			"blob-antenna-wiggle": "G-sUUq_blob-antenna-wiggle",
			"cat-blink": "G-sUUq_cat-blink",
			"blobEyes": "G-sUUq_blobEyes",
			"ghostHem": "G-sUUq_ghostHem",
			"sprite": "G-sUUq_sprite",
			"spriteGrid": "G-sUUq_spriteGrid",
			"catPencil": "G-sUUq_catPencil",
			"attentionDot": "G-sUUq_attentionDot",
			"blobFace": "G-sUUq_blobFace",
			"anchor": "G-sUUq_anchor",
			"menuItem": "G-sUUq_menuItem",
			"cat-breathe": "G-sUUq_cat-breathe",
			"botEyeRight": "G-sUUq_botEyeRight",
		...
		function HeadPencil({ className }) {
			return (0, react_jsx_runtime.jsxs)("g", {
				...
				children: [(0, react_jsx_runtime.jsx)("rect", {
					...
					rx: "2",
					fill: "var(--dsw-alias-label-primary, #1F2937)",
					transform: "rotate(45 70 18)"
				}), (0, react_jsx_runtime.jsx)("path", {
					d: "M66 26 L70 26 L70 34 L68 38 L66 34 Z",
		...
		function Blob({ pose, shift }) {
			...
			return (0, react_jsx_runtime.jsxs)("g", {
				className: SpriteMascot_module_css_default.blob,
				children: [
					(0, react_jsx_runtime.jsxs)("g", {
						className: SpriteMascot_module_css_default.blobAntenna,
					...
					(0, react_jsx_runtime.jsxs)("g", {
						className: SpriteMascot_module_css_default.blobBody,
						children: [(0, react_jsx_runtime.jsx)("circle", {
							cx: "60",
							cy: "70",
							r: "42",
					...
					showRegularEyes ? (0, react_jsx_runtime.jsxs)("g", {
						className: SpriteMascot_module_css_default.blobEyes,
						children: [(0, react_jsx_runtime.jsxs)("g", {
							className: SpriteMascot_module_css_default.blobEyeLeft,
							children: [
								(0, react_jsx_runtime.jsx)("circle", {
									cx: "46",
									cy: "66",
								...
								pupil !== null && (0, react_jsx_runtime.jsx)("circle", {
									cx: "46",
									cy: pupil.cy,
									r: pupil.r,
									fill: INK,
								...
								(0, react_jsx_runtime.jsx)("path", {
									className: SpriteMascot_module_css_default.blobEyelid,
									d: "M38 66 Q46 58 54 66 Q46 74 38 66 Z",
									fill: WHITE,
									stroke: INK,
									strokeWidth: "1"
								})
							...
							className: SpriteMascot_module_css_default.blobEyeRight,
							children: [
								(0, react_jsx_runtime.jsx)("circle", {
									cx: "74",
									cy: "66",
								...
								(0, react_jsx_runtime.jsx)("path", {
									className: SpriteMascot_module_css_default.blobEyelid,
									d: "M66 66 Q74 58 82 66 Q74 74 66 66 Z",
									fill: WHITE,
									stroke: INK,
									strokeWidth: "1"
								})
					...
					}) : pose === "error" ? (0, react_jsx_runtime.jsx)(CrossEyes, {}) : (0, react_jsx_runtime.jsx)(SmileEyes, {}),
					(0, react_jsx_runtime.jsx)("g", {
						className: SpriteMascot_module_css_default.blobFace,
						children: (0, react_jsx_runtime.jsx)(Mouth, { pose })
					}),
					(0, react_jsx_runtime.jsxs)("g", {
						className: SpriteMascot_module_css_default.blobCheeks,
					...
					pose === "writing" ? (0, react_jsx_runtime.jsx)(HeadPencil, { className: SpriteMascot_module_css_default.headPencil }) : (0, react_jsx_runtime.jsx)(Accessory, { pose })
				]
			});
		}
		function Bot({ pose, shift }) {
			...
			const showRegularEyes = pose !== "error" && pose !== "done";
			return (0, react_jsx_runtime.jsxs)("g", {
				className: SpriteMascot_module_css_default.bot,
				children: [
					...
					(0, react_jsx_runtime.jsxs)("g", {
						className: SpriteMascot_module_css_default.botAntenna,
						children: [(0, react_jsx_runtime.jsx)("path", {
							d: "M60 28 V14",
							stroke: "#059669",
							strokeWidth: "3",
					...
					(0, react_jsx_runtime.jsxs)("g", {
						className: SpriteMascot_module_css_default.botHead,
						children: [(0, react_jsx_runtime.jsx)("rect", {
							x: "18",
							y: "28",
							width: "84",
					...
					showRegularEyes ? (0, react_jsx_runtime.jsxs)("g", {
						className: SpriteMascot_module_css_default.botEyes,
						children: [(0, react_jsx_runtime.jsxs)("g", {
							className: SpriteMascot_module_css_default.botEyeLeft,
							children: [
								(0, react_jsx_runtime.jsx)("rect", {
									x: "36",
									y: "58",
								...
								(0, react_jsx_runtime.jsx)("rect", {
									className: SpriteMascot_module_css_default.botScan,
									x: "36",
									y: "58",
									width: "22",
									height: "15",
									rx: "4",
									fill: "url(#botScanGradient)",
									opacity: "0.4"
								})
							]
						}), (0, react_jsx_runtime.jsxs)("g", {
							className: SpriteMascot_module_css_default.botEyeRight,
							children: [
								(0, react_jsx_runtime.jsx)("rect", {
									x: "62",
									y: "58",
					...
					(0, react_jsx_runtime.jsxs)("g", {
						className: SpriteMascot_module_css_default.botMouth,
						children: [(0, react_jsx_runtime.jsx)("path", {
							d: "M55 88 L65 88",
							stroke: "#062033",
							strokeWidth: "3",
		...
		function CatAccessory({ pose }) {
			switch (pose) {
				case "thinking": return (0, react_jsx_runtime.jsxs)("g", {
					className: SpriteMascot_module_css_default.catThought,
					fill: "var(--dsw-alias-label-primary, #1F2937)",
					children: [
						(0, react_jsx_runtime.jsx)("circle", {
							cx: "58",
				...
				case "writing": return (0, react_jsx_runtime.jsxs)("g", {
					className: SpriteMascot_module_css_default.catPencil,
					children: [(0, react_jsx_runtime.jsx)("rect", {
						x: "66",
						y: "2",
						width: "8",
				...
				case "working": return (0, react_jsx_runtime.jsxs)("g", {
					className: SpriteMascot_module_css_default.catHeadGear,
				...
				case "waiting": return (0, react_jsx_runtime.jsxs)("g", {
					className: SpriteMascot_module_css_default.catSpeech,
					children: [
						(0, react_jsx_runtime.jsx)("ellipse", {
							cx: "92",
							cy: "54",
				...
				case "error": return (0, react_jsx_runtime.jsx)("path", {
					className: SpriteMascot_module_css_default.catSweat,
					d: "M48 44 q5 7 0 12 q-5 -5 0 -12 Z",
					fill: "var(--dsw-alias-state-error-primary, #EF4444)"
				});
				case "done": return (0, react_jsx_runtime.jsxs)("g", {
					className: SpriteMascot_module_css_default.catStars,
					fill: "var(--dsw-alias-state-success-primary, #22C55E)",
					children: [
						(0, react_jsx_runtime.jsx)("path", {
							className: SpriteMascot_module_css_default.star,
							d: "M60 10 Q62 15 67 17 Q62 19 60 24 Q58 19 53 17 Q58 15 60 10 Z"
						}),
						(0, react_jsx_runtime.jsx)("path", {
							className: SpriteMascot_module_css_default.star,
							d: "M28 28 Q30 32 34 34 Q30 36 28 40 Q26 36 22 34 Q26 32 28 28 Z"
						}),
						(0, react_jsx_runtime.jsx)("path", {
							className: SpriteMascot_module_css_default.star,
							d: "M96 30 Q98 33 101 35 Q98 37 96 40 Q94 37 91 35 Q94 33 96 30 Z"
						})
					]
				});
				default: return null;
		...
		function Cat({ pose, shift }) {
			...
			const showRegularEyes = pose !== "error" && pose !== "done";
			return (0, react_jsx_runtime.jsxs)("g", {
				className: SpriteMascot_module_css_default.cat,
				children: [
					(0, react_jsx_runtime.jsx)("g", {
						className: SpriteMascot_module_css_default.catTail,
						children: (0, react_jsx_runtime.jsx)("path", {
					...
					(0, react_jsx_runtime.jsx)("g", {
						className: SpriteMascot_module_css_default.catBody,
						children: (0, react_jsx_runtime.jsx)("circle", {
							cx: "60",
							cy: "72",
							r: "42",
					...
					(0, react_jsx_runtime.jsxs)("g", {
						className: SpriteMascot_module_css_default.catEars,
						children: [(0, react_jsx_runtime.jsxs)("g", {
							className: SpriteMascot_module_css_default.catEarLeft,
							children: [(0, react_jsx_runtime.jsx)("path", {
								d: "M32 46 L40 18 L54 38 Z",
								fill: "var(--dsw-static-amber-400, #FBBF24)",
								stroke: "var(--dsw-static-amber-600, #D97706)",
								strokeWidth: "1.5"
							}), (0, react_jsx_runtime.jsx)("path", {
								d: "M37 40 L40 26 L50 36 Z",
								fill: "var(--dsw-static-amber-300, #FCD34D)"
							})]
						}), (0, react_jsx_runtime.jsxs)("g", {
							className: SpriteMascot_module_css_default.catEarRight,
							children: [(0, react_jsx_runtime.jsx)("path", {
								d: "M66 38 L80 18 L88 46 Z",
								fill: "var(--dsw-static-amber-400, #FBBF24)",
								stroke: "var(--dsw-static-amber-600, #D97706)",
								strokeWidth: "1.5"
							}), (0, react_jsx_runtime.jsx)("path", {
								d: "M70 36 L80 26 L83 40 Z",
								fill: "var(--dsw-static-amber-300, #FCD34D)"
							})]
						})]
					}),
					(0, react_jsx_runtime.jsxs)("g", {
						className: SpriteMascot_module_css_default.catFace,
						children: [
							(0, react_jsx_runtime.jsx)("path", {
							...
							showRegularEyes ? (0, react_jsx_runtime.jsxs)("g", {
								className: SpriteMascot_module_css_default.catEyes,
								children: [(0, react_jsx_runtime.jsxs)("g", {
									className: SpriteMascot_module_css_default.catEyeLeft,
									children: [
										(0, react_jsx_runtime.jsx)("ellipse", {
											cx: "46",
											cy: "66",
										...
										pupil !== null && (0, react_jsx_runtime.jsx)("ellipse", {
											cx: "46",
											cy: pupil.cy,
											rx: "3.5",
											ry: "6.5",
										...
										(0, react_jsx_runtime.jsx)("path", {
											className: SpriteMascot_module_css_default.catEyelid,
											d: "M39 66 Q46 56 53 66 Q46 76 39 66 Z",
											fill: WHITE,
											stroke: INK,
											strokeWidth: "1"
										})
									...
									className: SpriteMascot_module_css_default.catEyeRight,
									children: [
										(0, react_jsx_runtime.jsx)("ellipse", {
											cx: "74",
											cy: "66",
										...
										(0, react_jsx_runtime.jsx)("path", {
											className: SpriteMascot_module_css_default.catEyelid,
											d: "M67 66 Q74 56 81 66 Q74 76 67 66 Z",
											fill: WHITE,
											stroke: INK,
											strokeWidth: "1"
										})
							...
							(0, react_jsx_runtime.jsxs)("g", {
								className: SpriteMascot_module_css_default.catWhiskers,
								children: [
									(0, react_jsx_runtime.jsx)("path", {
										d: "M34 74 H44",
										stroke: INK,
							...
							(0, react_jsx_runtime.jsx)("path", {
								d: "M58 78 L62 78 L60 81 Z",
								fill: "var(--dsw-static-amber-600, #D97706)"
							}),
					...
					(0, react_jsx_runtime.jsxs)("g", {
						className: SpriteMascot_module_css_default.catPaws,
						children: [(0, react_jsx_runtime.jsx)("ellipse", {
							cx: "44",
							cy: "108",
							rx: "7",
					...
					(0, react_jsx_runtime.jsx)(CatAccessory, { pose })
				]
			});
		}
		function Ghost({ pose, shift }) {
			...
			const showRegularEyes = pose !== "error" && pose !== "done";
			return (0, react_jsx_runtime.jsxs)("g", {
				className: SpriteMascot_module_css_default.ghost,
				children: [
					(0, react_jsx_runtime.jsxs)("g", {
						className: SpriteMascot_module_css_default.ghostBody,
						children: [(0, react_jsx_runtime.jsx)("path", {
					...
					(0, react_jsx_runtime.jsx)("g", {
						className: SpriteMascot_module_css_default.ghostHem,
						children: (0, react_jsx_runtime.jsx)("path", {
					...
					showRegularEyes ? (0, react_jsx_runtime.jsxs)("g", {
						className: SpriteMascot_module_css_default.ghostEyes,
						children: [(0, react_jsx_runtime.jsxs)("g", {
							className: SpriteMascot_module_css_default.ghostEyeLeft,
							children: [
								(0, react_jsx_runtime.jsx)("circle", {
									cx: "46",
									cy: "66",
								...
								(0, react_jsx_runtime.jsx)("path", {
									className: SpriteMascot_module_css_default.ghostEyelid,
									d: "M37 66 Q46 57 55 66 Q46 75 37 66 Z",
									fill: WHITE,
									stroke: INK,
									strokeWidth: "1"
								})
							...
							className: SpriteMascot_module_css_default.ghostEyeRight,
							children: [
								(0, react_jsx_runtime.jsx)("circle", {
									cx: "74",
									cy: "66",
								...
								(0, react_jsx_runtime.jsx)("path", {
									className: SpriteMascot_module_css_default.ghostEyelid,
									d: "M65 66 Q74 57 83 66 Q74 75 65 66 Z",
									fill: WHITE,
									stroke: INK,
									strokeWidth: "1"
								})
					...
					(0, react_jsx_runtime.jsx)("g", {
						className: SpriteMascot_module_css_default.ghostFace,
						children: (0, react_jsx_runtime.jsx)(Mouth, { pose })
					}),
					(0, react_jsx_runtime.jsxs)("g", {
						className: SpriteMascot_module_css_default.ghostCheeks,
						children: [(0, react_jsx_runtime.jsx)("ellipse", {
							cx: "36",
							cy: "78",
							rx: "4",
							ry: "2.5",
							fill: "var(--dsw-static-purple-200, #DDD6FE)",
							opacity: "0.5"
						}), (0, react_jsx_runtime.jsx)("ellipse", {
							cx: "84",
							cy: "78",
		...
		*/
		const SpriteSvg = (0, react.memo)(function SpriteSvg({ kind, pose, gaze }) {
			return (0, react_jsx_runtime.jsx)("svg", {
				viewBox: "0 0 120 120",
				"aria-hidden": "true",
				focusable: "false",
				children: renderSprite(kind, pose, gaze)
			});
		});
		/**
		...
		*/
		function SpriteMascot({ useSprite, useBackground, useSpriteKind, usePosition, startSession, setBackground, setSpriteKind, setPosition, t }) {
				...
				children: [
					(0, react_jsx_runtime.jsxs)("button", {
						...
						children: [(activity === "waiting" || activity === "error") && (0, react_jsx_runtime.jsx)("span", {
							...
							className: SpriteMascot_module_css_default.spriteBody,
							children: (0, react_jsx_runtime.jsx)(SpriteSvg, {
								kind: spriteKind,
								pose,
								gaze
							})
					...
					panel === "menu" && (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							(0, react_jsx_runtime.jsxs)("div", {
								className: SpriteMascot_module_css_default.menuStatus,
								"aria-live": "polite",
								children: [(0, react_jsx_runtime.jsx)("span", {
									className: SpriteMascot_module_css_default.menuStatusDot,
									"data-activity": activity,
									"aria-hidden": "true"
								}), (0, react_jsx_runtime.jsx)("span", {
									className: SpriteMascot_module_css_default.menuStatusText,
									children: caption
								})]
							}),
							(0, react_jsx_runtime.jsxs)("button", {
		...
		*/
		...
		exports.apply = apply;
		exports.createSpritePositionSource = createSpritePositionSource;
